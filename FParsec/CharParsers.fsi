...
val runParserOnSubstring:
    Parser<'a, 'u> -> 'u -> streamName: string -> string -> int -> int -> ParserResult<'a, 'u>
...
/// The parser's `Reply` is captured and returned as a `ParserResult` value.
val runParserOnFile:
    Parser<'a, 'u> -> 'u -> path: string -> System.Text.Encoding -> ParserResult<'a, 'u>
#endif
...
type IdentifierOptions =
    new:
        ?isAsciiIdStart: (char -> bool) *
        ?isAsciiIdContinue: (char -> bool) *
        ?allowJoinControlChars: System.Text.NormalizationForm *
...
val manyCharsTillApply2:
    Parser<char, 'u> -> Parser<char, 'u> -> Parser<'b, 'u> -> (string -> 'b -> 'c) -> Parser<'c, 'u>
...
val many1CharsTillApply:
    Parser<char, 'u> -> Parser<'b, 'u> -> (string -> 'b -> 'c) -> Parser<'c, 'u>
...
and [<System.Flags>] NumberLiteralResultFlags =
    | None = 0
